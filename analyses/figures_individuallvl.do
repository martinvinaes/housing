...
scatter _margin model if dv==1, msym(O) msize(vlarge) mlwidth(medthick) mlcolor(black) mfcolor(white)  ///
yline(0) ylab(-0.2(0.1)0.31,  labsize(medlarge)) xtitle(" ") ///
xlab(1 "20 closest" 2 "40 closest" 3 "1000 metres" 4 "1500 metres" 5 "Zip code" 6.5 "Bivariate" 7.5 "+ Year FE" 8.5 "+ Precinct FE" 9.5 "+ Controls" 10 " ", notick alternate labsize(medlarge)) ///
ytitle("Unstandardized effect size", size(medlarge)) xlines(5.75) xtick(1 2 3 4 5 6.5 7.5 8.5 9.75) /// 
legend(off)  xsize(6) ///
