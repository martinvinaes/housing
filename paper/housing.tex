...
\begin{figure}[htbp]
	...
	\centering
	\caption{Predicted electoral support for governing parties across changes in house prices with 90 and 95 pct. confidence intervals. Derived from model (5) in table \ref{tab4}}
	\label{posneg}
\end{figure}
...
\begin{figure}[htbp]
	...
	\centering
	\caption{Predicted electoral support for governing parties across changes in house prices at the 5th and 95th percentile of the volatility variable with 90 and 95 pct. confidence intervals. Derived from model (5) in table \ref{tab5}}
	\label{vola}
\end{figure}
