...
\newpage	
	...
	%We have tested the two hypotheses in what we argue to be a close to ideal testbed: the highly volatile local housing markets in Denmark during the housing boom and bust of the Great Recession. More specifically, we merge precinct-level panel data on election outcomes and individual-level panel survey data on vote choice with exceptionally precise and flexible registry data on local housing markets to test the hypothesized relationship at a very local, and thus theoretically more appropriate, level of analysis. 
