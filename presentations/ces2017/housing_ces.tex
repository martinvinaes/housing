...
\begin{columns}
	\column{.45\textwidth}
	\includegraphics[height=2in]{../../figures/eurostat}
	\pause
	\column{.55\textwidth}
	\only<2->{\includegraphics[height=2in]{../../figures/sold}}
	\end{columns}	
\end{frame}
...
\pause
		...
		\pause
		\begin{block}{}
			>>(...) local economic conditions related to the housing market \alert{do not appear to play an important role} in U.S. election results (...)<< (Hall et al., 2017) 
		\end{block}
